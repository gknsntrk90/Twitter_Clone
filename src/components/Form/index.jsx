...
const Form = ({user}) => {
    ...
    const handleSubmit = async (e) => {
        ...
        //* 2- yazı ve resim içeriği yoksa fonksyonları durdur
        if (!text && !image) {
            return toast.warning("Lütfen içerik giriniz", {position:
                "bottom-right"});
        }
  ...
  return (
    ...
    className='flex gap-3 border-b border-zinc-600 p-4'>
        ...
        <div className='w-full'>
            <input className='w-full mt-1 mb-2 bg-transparent
            outline-none md:text-lg' type="text" 
